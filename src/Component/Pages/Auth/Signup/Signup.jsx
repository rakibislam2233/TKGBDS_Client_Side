      ...
      .then((imageData) => {
        ...
        createNewUser(email, password)
          .then((result) => {
            ...
            const userInfo = { name, email, imageUrl, phone,lastBDD};
        ...
        <div className="w-full max-w-[500px] p-6 rounded-2xl sm:p-10 bg-gray-100 text-gray-900">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-2">
            ...
            <div className="py-3">
              ...
              >
                  {
                  loading ? <div className="flex justify-center"><ImSpinner9 className="w-8 h-8 animate-spin"></ImSpinner9></div> : ' Create Account'
                }
